...
from misaka.ui.pages.settings.appearance_section import (
...
from misaka.ui.pages.settings.provider_section import (
            ...
            content=ft.Row(
                controls=[
                    ft.Column(
                        controls=[
                            ft.Text(
                                t("settings.claude_debug_log"),
                                size=13, weight=ft.FontWeight.W_500,
                            ),
                            ft.Text(
                                t("settings.claude_debug_log_desc"),
                                size=11, opacity=0.6,
                            ),
                        ],
                        spacing=2,
