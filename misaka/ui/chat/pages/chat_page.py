...
class ChatPage(ft.Stack):
    ...
    def _purge_rag_cache_for_session(self, session_id: str) -> None:
        """Remove RAG result cache entries for messages in the current state.

        Only cleans up entries for messages currently loaded in
